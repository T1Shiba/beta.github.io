document.addEventListener('DOMContentLoaded', () => {
    ...
    const gameData = {
        'monster-hunter-wilds': {
            ...
            steamLink: 'https://store.steampowered.com/app/1938110/MONSTER_HUNTER_WILDS/',
        ...
        'repo': {
            ...
            publisherLink: 'https://www.repo-game.com',
            steamLink: 'https://store.steampowered.com/app/123456/repo/',
        ...
        'assassins-creed-shadows': {
            ...
            steamLink: 'https://store.steampowered.com/app/234567/assassins_creed_shadows/',
    ...
    // Chuyển hướng khi nhấp vào "Games news"
    document.querySelector('.news-link[data-news="GAMES-NEWS"]').addEventListener('click', (e) => {
        e.preventDefault();
        window.location.href = '/html/news.html'; // Chuyển tới file games-news.html
    });
